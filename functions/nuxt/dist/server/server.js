...
/******/ 			var chunk = require("./" + ({"1":"components/c-i-values","2":"components/contact-form","3":"components/footer","4":"components/header","5":"components/invitaciones","6":"components/products","7":"components/quote","8":"components/recent-blog","9":"components/services","10":"components/slides","11":"components/testimonials","12":"pages/contacto","13":"pages/index"}[chunkId]||chunkId) + ".js");
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ":root{--neutral-90:#1c2c33;--neutral-80:#34444b;--neutral-70:#4c5b62;--neutral-60:#647379;--nuetral-50:#7d8a90;--neutral-40:#96a1a6;--neutral-30:#96a1a6;--neutral-20:#afb8bc;--neutral-10:#c9cfd2;--neutral-00:#fff;--primary-90:#1d3845;--primary-80:#2b505c;--primary-70:#3b6971;--primary-60:#4c8184;--primary-50:#5f9695;--primary-40:#7fafb2;--primary-30:#a1c5cb;--primary-20:#c6dce2;--primary-10:#edf4f7;--secondary-90:#663b53;--secondary-80:#8c5567;--secondary-70:#b37279;--secondary-60:#d99691;--secondary-50:#ffc4b2;--secondary-40:#ffd3bb;--secondary-30:#ffe2c8;--secondary-20:#ffefd7;--secondary-10:#fff9e9;--fontFamilyMontserrat:\"Montserrat\",sans-serif;--fontFamilyOvo:\"Ovo\",serif;--fontFamilyPlayfair:\"Playfair Display\",serif;--fontSizeExtraSmall:10px;--fontSizeSmall:14px;--fontSizeMedium:16px;--fontSizeLarge:24px;--fontSizeXLarge:32px;--fontSizeHeaderExtraSmall:24px;--fontSizeHeaderSmall:calc(23.57895px + 0.42105vw);--fontSizeHeaderMedium:calc(23.15789px + 0.84211vw);--fontSizeHeaderLarge:calc(22.73684px + 1.26316vw);--fontSizeHeaderXLarge:calc(22.31579px + 1.68421vw);--fontSizeHeaderXXLarge:calc(21.89474px + 2.10526vw);--paragraphLineHeight:40px}*,:after,:before{box-sizing:border-box;margin:0}h1,h2,h3,h4,h5{font-family:\"Playfair Display\",serif;font-family:var(--fontFamilyPlayfair)}body{margin:0;padding:0;background-color:#fff;background-color:var(--neutral-00);font-family:\"Montserrat\",sans-serif;font-family:var(--fontFamilyMontserrat)}p{font-size:16px;font-size:var(--fontSizeMedium);color:#1d3845;color:var(--primary-90)}a{text-decoration:none}button{cursor:pointer}.paragraphStyle{line-height:40px;line-height:var(--paragraphLineHeight)}.header2{font-size:calc(22.73684px + 1.26316vw);font-size:var(--fontSizeHeaderLarge);color:#4c8184;color:var(--primary-60);font-style:italic}.primaryBtn{font-size:16px;font-size:var(--fontSizeMedium);color:#663b53;color:var(--secondary-90);background-color:#ffc4b2;background-color:var(--secondary-50);display:inline-block;padding:14px 62px}.primaryBtn,.secondaryBtn{font-weight:600;border:8px solid #fff;border:8px solid var(--neutral-00);border-radius:0}.secondaryBtn{font-family:\"Playfair Display\",serif;font-family:var(--fontFamilyPlayfair);font-size:calc(23.15789px + .84211vw);font-size:var(--fontSizeHeaderMedium);font-style:italic;color:#fff;color:var(--neutral-00);padding:4px 16px;background-color:#1d3845;background-color:var(--primary-90)}.tertiaryBtn{font-family:\"Montserrat\",sans-serif;font-family:var(--fontFamilyMontserrat);font-weight:600;color:#663b53;color:var(--secondary-90);width:195px;height:56px;border:1px solid #fff;border:1px solid var(--neutral-00);border-radius:0;background-color:#ffc4b2;background-color:var(--secondary-50);margin-top:24px}.container{width:100%;max-width:1152px;margin:0 auto}@media screen and (max-width:426px){body{margin-bottom:48px}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
__webpack_require__.d(components_namespaceObject, "CIValues", function() { return CIValues; });
...
__webpack_require__.d(components_namespaceObject, "Invitaciones", function() { return Invitaciones; });
__webpack_require__.d(components_namespaceObject, "Products", function() { return Products; });
__webpack_require__.d(components_namespaceObject, "Quote", function() { return Quote; });
__webpack_require__.d(components_namespaceObject, "RecentBlog", function() { return RecentBlog; });
...
__webpack_require__.d(components_namespaceObject, "Testimonials", function() { return Testimonials; });
...
const _79db504e = () => interopDefault(__webpack_require__.e(/* import() | pages/contacto */ 12).then(__webpack_require__.bind(null, 104)));

const _c37c7990 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 13).then(__webpack_require__.bind(null, 105)));
...
const CIValues = () => __webpack_require__.e(/* import() | components/c-i-values */ 1).then(__webpack_require__.bind(null, 101)).then(c => wrapFunctional(c.default || c));
const ContactForm = () => __webpack_require__.e(/* import() | components/contact-form */ 2).then(__webpack_require__.bind(null, 95)).then(c => wrapFunctional(c.default || c));
const Footer = () => __webpack_require__.e(/* import() | components/footer */ 3).then(__webpack_require__.bind(null, 31)).then(c => wrapFunctional(c.default || c));
const Header = () => __webpack_require__.e(/* import() | components/header */ 4).then(__webpack_require__.bind(null, 30)).then(c => wrapFunctional(c.default || c));
const Invitaciones = () => __webpack_require__.e(/* import() | components/invitaciones */ 5).then(__webpack_require__.bind(null, 97)).then(c => wrapFunctional(c.default || c));
const Products = () => __webpack_require__.e(/* import() | components/products */ 6).then(__webpack_require__.bind(null, 99)).then(c => wrapFunctional(c.default || c));
const Quote = () => __webpack_require__.e(/* import() | components/quote */ 7).then(__webpack_require__.bind(null, 102)).then(c => wrapFunctional(c.default || c));
const RecentBlog = () => __webpack_require__.e(/* import() | components/recent-blog */ 8).then(__webpack_require__.bind(null, 103)).then(c => wrapFunctional(c.default || c));
const Services = () => __webpack_require__.e(/* import() | components/services */ 9).then(__webpack_require__.bind(null, 98)).then(c => wrapFunctional(c.default || c));
const Slides = () => __webpack_require__.e(/* import() | components/slides */ 10).then(__webpack_require__.bind(null, 96)).then(c => wrapFunctional(c.default || c));
const Testimonials = () => __webpack_require__.e(/* import() | components/testimonials */ 11).then(__webpack_require__.bind(null, 100)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
/* harmony default export */ var _nuxt_recaptcha = (function (_, inject) {
  ...
  external_vue_default.a.component('Recaptcha', () => __webpack_require__.e(/* import() */ 14).then(__webpack_require__.bind(null, 106)));
...
// EXTERNAL MODULE: ./.nuxt/dist.plugin.032569f2.js
var dist_plugin_032569f2 = __webpack_require__(9);
var dist_plugin_032569f2_default = /*#__PURE__*/__webpack_require__.n(dist_plugin_032569f2);
...
/* Plugins */
 ...
 // Source: ./dist.plugin.032569f2.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof dist_plugin_032569f2_default.a === 'function') {
    await dist_plugin_032569f2_default()(app.context, inject);
